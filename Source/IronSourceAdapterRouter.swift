...
extension IronSourceAdapterRouter {
    private func interstitialAd(for partnerPlacement: String, functionName: StaticString = #function) -> IronSourceAdapterInterstitialAd? {
        ad(for: partnerPlacement, functionName: functionName) as IronSourceAdapterInterstitialAd?
    }

    private func rewardedAd(for partnerPlacement: String, functionName: StaticString = #function) -> IronSourceAdapterRewardedAd? {
    ...
    private func ad<T: PartnerAd>(for partnerPlacement: String, functionName: StaticString = #function) -> T? {
